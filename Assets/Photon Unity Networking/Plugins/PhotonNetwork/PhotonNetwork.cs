...
public static class PhotonNetwork
{
    ...
    public static void CreateSettings()
    {
        ...
        if (PhotonNetwork.PhotonServerSettings == null)
        {
			...
			_PunResourcesPath += "Assets/Photon Unity Networking/Resources/";

			//Gu,
			string serverSettingsAssetPath = _PunResourcesPath+ PhotonNetwork.serverSettingsAssetFile + ".asset";//"Assets/Photon Unity Networking/Resources/"+PhotonNetwork.serverSettingsAssetFile+".asset";
